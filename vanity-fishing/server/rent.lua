...
lib.callback.register('vanity_fishing:rentVehicle', function(source, index)
...
RegisterNetEvent('vanity_fishing:registerBoat', function(netId)
    local source = source
...
lib.callback.register('vanity_fishing:returnVehicle', function(source, netId)
    local player = Framework.getPlayerFromId(source)
