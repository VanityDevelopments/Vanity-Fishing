lib.locale()
lib.versionCheck('https://github.com/VanityDevelopments/vanity_fishing')
    ...
    local connect = {
        {
            ...
            ["footer"] = {
                ...
                ["icon_url"] = 'https://cdn.discordapp.com/attachments/793081015433560075/1048643072952647700/vanity.png',
            },
        }
    }
...
lib.callback.register('vanity_fishing:getItemLabels', function()
